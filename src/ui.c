...
{                                 // função menu.
   ...
   printf("Caso queira desmarcar a casa marcada como minada ou dúvida, digite a coordenada e a opção de jogada da casa marcada\n \n") ;
...
{                                                        // está função apresenta ao usuário o resultado.
